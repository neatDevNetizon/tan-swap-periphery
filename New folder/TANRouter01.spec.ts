...
enum RouterVersion {
  TANRouter01 = 'TANRouter01',
  TANRouter02 = 'TANRouter02'
}

describe('TANRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.TANRouter01]: fixture.router01,
        [RouterVersion.TANRouter02]: fixture.router02
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.TANRouter01]: 102328,
              [RouterVersion.TANRouter02]: 102338
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
